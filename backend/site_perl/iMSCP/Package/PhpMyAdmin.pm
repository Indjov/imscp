...
iMSCP::Package::PhpMyAdmin - i-MSCP PhpMyAdmin package
...
package iMSCP::Package::PhpMyAdmin;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Package::PhpMyAdmin::Installer iMSCP::Package::PhpMyAdmin::Uninstaller /;
use iMSCP::Config;
...
sub registerSetupListeners
{
    ...
    iMSCP::Package::PhpMyAdmin::Installer->getInstance()->registerSetupListeners( $eventManager );
}
...
sub uninstall
{
    iMSCP::Package::PhpMyAdmin::Uninstaller->getInstance()->uninstall();
}
...
=item _init()
 ...
 Return iMSCP::Package::PhpMyAdmin
