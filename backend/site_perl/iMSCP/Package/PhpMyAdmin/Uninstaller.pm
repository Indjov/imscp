...
iMSCP::Package::PhpMyAdmin::Uninstaller - i-MSCP PhpMyAdmin package uninstaller
...
package iMSCP::Package::PhpMyAdmin::Uninstaller;
...
=item _init()
 ...
 Return iMSCP::Package::PhpMyAdmin::Uninstaller
