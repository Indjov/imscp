...
iMSCP::Package::FileManager::Net2ftp::Installer - i-MSCP Net2ftp package installer
...
package iMSCP::Package::FileManager::Net2ftp::Installer;
...
=item _init()
 ...
 Return iMSCP::Package::FileManager::Net2ftp::Installer
...
sub _buildHttpdConfig
{
    ...
    $frontEnd->buildConfFile(
        "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/FileManager/Net2ftp/config/nginx/imscp_net2ftp.conf",
        {
