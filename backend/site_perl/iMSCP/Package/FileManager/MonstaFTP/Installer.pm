...
iMSCP::Package::FileManager::MonstaFTP::Installer - i-MSCP MonstaFTP package installer
...
package iMSCP::Package::FileManager::MonstaFTP::Installer;
...
=item _init()
 ...
 Return iMSCP::Package::FileManager::MonstaFTP::Installer
