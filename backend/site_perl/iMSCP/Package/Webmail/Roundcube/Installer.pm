...
iMSCP::Package::Webmail::Roundcube::Installer - i-MSCP Roundcube package installer
...
package iMSCP::Package::Webmail::Roundcube::Installer;
...
=head1 DESCRIPTION
 ...
 See iMSCP::Package::Webmail::Roundcube::Roundcube for more information.
...
=item _init()
 ...
 Return iMSCP::Package::Webmail::Roundcube::Installer
...
sub _init
{
    ...
    $self->{'roundcube'} = iMSCP::Package::Webmail::Roundcube::Roundcube->getInstance();
