...
iMSCP::Package::Webmail::Roundcube::Uninstaller - i-MSCP Roundcube package uninstaller
...
package iMSCP::Package::Webmail::Roundcube::Uninstaller;
...
use iMSCP::iMSCP::Package::Webmail::Roundcube::Roundcube;
...
=item _init()
 ...
 Return iMSCP::Package::Webmail::Roundcube::Uninstaller
...
sub _init
{
    ...
    $self->{'frontend'} = iMSCP::Package::FrontEnd->getInstance();
