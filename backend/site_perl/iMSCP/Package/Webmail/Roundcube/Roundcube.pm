...
iMSCP::Package::Webmail::Roundcube::Roundcube - i-MSCP Roundcube package
...
package iMSCP::Package::Webmail::Roundcube::Roundcube;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Package::Webmail::Roundcube::Installer iMSCP::Package::Webmail::Roundcube::Uninstaller /;
use iMSCP::Config;
use iMSCP::Debug;
use iMSCP::Database;
use iMSCP::Rights;
...
sub showDialog
{
    ...
    iMSCP::Package::Webmail::Roundcube::Installer->getInstance()->showDialog( $dialog );
}
...
sub preinstall
{
    iMSCP::Package::Webmail::Roundcube::Installer->getInstance()->preinstall();
}
...
sub install
{
    iMSCP::Package::Webmail::Roundcube::Installer->getInstance()->install();
}
...
sub uninstall
{
    iMSCP::Package::Webmail::Roundcube::Uninstaller->getInstance()->uninstall();
}
...
=item _init()
 ...
 Return iMSCP::Package::Webmail::Roundcube::Roundcube
