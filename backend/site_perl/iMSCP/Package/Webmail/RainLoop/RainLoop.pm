...
iMSCP::Package::Webmail::RainLoop::RainLoop - i-MSCP RainLoop package
...
package iMSCP::Package::Webmail::RainLoop::RainLoop;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Package::Webmail::RainLoop::Installer iMSCP::Package::Webmail::RainLoop::Uninstaller /;
use iMSCP::Config;
use iMSCP::Debug;
use iMSCP::Database;
use iMSCP::Dir;
...
sub showDialog
{
    ...
    iMSCP::Package::Webmail::RainLoop::Installer->getInstance()->showDialog( $dialog );
}
...
sub preinstall
{
    iMSCP::Package::Webmail::RainLoop::Installer->getInstance()->preinstall();
}
...
sub install
{
    iMSCP::Package::Webmail::RainLoop::Installer->getInstance()->install();
}
...
sub uninstall
{
    iMSCP::Package::Webmail::RainLoop::Uninstaller->getInstance()->uninstall();
}
...
=item _init()
 ...
 Return iMSCP::Package::Webmail::RainLoop::RainLoop
