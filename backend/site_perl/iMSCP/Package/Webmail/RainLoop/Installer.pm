...
iMSCP::Package::Webmail::RainLoop::Installer - i-MSCP RainLoop package installer
...
package iMSCP::Package::Webmail::RainLoop::Installer;
...
=head1 DESCRIPTION
 ...
 See iMSCP::Package::Webmail::RainLoop::RainLoop for more information.
...
=item _init()
 ...
 Return iMSCP::Package::Webmail::RainLoop::Installer
...
sub _init
{
    ...
    $self->{'rainloop'} = iMSCP::Package::Webmail::RainLoop::RainLoop->getInstance();
