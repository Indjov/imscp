...
iMSCP::Package::FileManager - i-MSCP FileManager package
...
package iMSCP::Package::FileManager;
...
EOF
    ...
    $package = "iMSCP::Package::FileManager::${package}::${package}";
...
=item init()
 ...
 Return iMSCP::Package::FileManager
...
sub _init
{
    ...
    @{$self->{'PACKAGES'}}{
        iMSCP::Dir->new( dirname => "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/FileManager" )->getDirs()
    } = ();
