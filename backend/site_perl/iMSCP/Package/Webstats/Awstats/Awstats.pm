...
iMSCP::Package::Webstats::Awstats::Awstats - i-MSCP AWStats package
...
package iMSCP::Package::Webstats::Awstats::Awstats;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Package::Webstats::Awstats::Installer iMSCP::Package::Webstats::Awstats::Uninstaller /;
use iMSCP::Database;
use iMSCP::Debug;
use iMSCP::Dir;
...
sub install
{
    iMSCP::Package::Webstats::Awstats::Installer->getInstance()->install();
}
...
sub uninstall
{
    iMSCP::Package::Webstats::Awstats::Uninstaller->getInstance()->uninstall();
}
...
sub setEnginePermissions
{
    ...
    my $rs = setRights(
        "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/Webstats/Awstats/Scripts/awstats_updateall.pl",
        {
...
sub _addAwstatsConfig
{
    ...
    my $awstatsPackageRootDir = "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/Webstats/Awstats";
