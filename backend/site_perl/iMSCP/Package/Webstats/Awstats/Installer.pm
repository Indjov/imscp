...
iMSCP::Package::Webstats::Awstats::Installer - i-MSCP AWStats package installer
...
package iMSCP::Package::Webstats::Awstats::Installer;
...
=head1 DESCRIPTION
 ...
 See iMSCP::Package::Webstats::Awstats::Awstats for more information.
...
=item _init()
 ...
 Return iMSCP::Package::Webstats::Awstats::Installer
...
sub _setupApache2
{
    ...
    $rs = $self->{'httpd'}->buildConfFile(
        "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/Webstats/Awstats/Config/01_awstats.conf"
    );
    ...
    iMSCP::Servers::cron->factory()->addTask(
        {
            ...
            COMMAND => 'nice -n 15 ionice -c2 -n5 perl '.
                "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/Webstats/Awstats/Scripts/awstats_updateall.pl now ".
