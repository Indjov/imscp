...
iMSCP::Package::AntiRootkits - i-MSCP Anti-Rootkits package
...
package iMSCP::Package::AntiRootkits;
...
EOF
    ...
    for (keys %{$self->{'PACKAGES'}}) {
        ...
        my $package = "iMSCP::Package::AntiRootkits::${_}::${_}";
...
=item init()
 ...
 Return iMSCP::Package::AntiRootkits
...
sub _init
{
    ...
    @{$self->{'PACKAGES'}}{
        iMSCP::Dir->new( dirname => "$main::imscpConfig{'ENGINE_LIB_DIR'}/Package/AntiRootkits" )->getDirs()
    } = ();
    $self;
}
