...
iMSCP::Package::AntiRootkits::Chkrootkit::Installer - i-MSCP Chkrootkit package installer
...
package iMSCP::Package::AntiRootkits::Chkrootkit::Installer;
...
sub _addCronTask
{
    iMSCP::Servers::cron->factory()->addTask(
        {
            TASKID  => 'iMSCP::Package::AntiRootkits::Chkrootkit',
            MINUTE  => '@weekly',
            HOUR    => '',
            DAY     => '',
            MONTH   => '',
