...
iMSCP::Package::FrontEnd::Installer - i-MSCP FrontEnd package installer
...
package iMSCP::Package::FrontEnd::Installer;
...
=item _init()
 ...
 Return iMSCP::Package::FrontEnd::Installer
...
sub _addDnsZone
{
    ...
    $rs ||= iMSCP::Servers::named->factory()->addDmn(
        {
            BASE_SERVER_VHOST     => main::setupGetQuestion( 'BASE_SERVER_VHOST' ),
...
sub _deleteDnsZone
{
    ...
    $rs ||= iMSCP::Servers::named->factory()->deleteDmn( { DOMAIN_NAME => $main::imscpOldConfig{'BASE_SERVER_VHOST'} } );
