=head1 NAME
 ...
 iMSCP::Servers::named::bind - i-MSCP Bind9 Server implementation
...
package iMSCP::Servers::named::bind;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Servers::named::bind::installer iMSCP::Servers::named::bind::uninstaller /;
use File::Basename;
use iMSCP::Debug;
use iMSCP::Config;
...
sub registerSetupListeners
{
    ...
    iMSCP::Servers::named::bind::installer->getInstance()->registerSetupListeners( $eventManager );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Servers::named::bind::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::named::bind::uninstaller->getInstance()->uninstall();
    return $rs if $rs;
...
=item _init()
 ...
 Return iMSCP::Servers::named::bind
