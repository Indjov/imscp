=head1 NAME
 ...
 iMSCP::Servers::named::bind::uninstaller - i-MSCP Bind9 Server implementation
...
package iMSCP::Servers::named::bind::uninstaller;
...
=item _init()
 ...
 Return iMSCP::Servers::named::bind::uninstaller
...
sub _init
{
    ...
    $self->{'named'} = iMSCP::Servers::named::bind->getInstance();
