=head1 NAME
 ...
 iMSCP::Servers::mta::postfix::installer - i-MSCP Postfix MTA server installer implementation
...
package iMSCP::Servers::mta::postfix::installer;
...
=item _init()
 ...
 Return iMSCP::Servers::mta::postfix::installer
...
sub _buildMasterCfFile
{
    ...
    my $data = {
        ...
        ARPL_PATH            => $main::imscpConfig{'BINDIR'}."/engine/messenger/imscp-arpl-msgr"
    };
