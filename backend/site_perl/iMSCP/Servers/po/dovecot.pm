=head1 NAME
 ...
 iMSCP::Servers::po::dovecot - i-MSCP Dovecot IMAP/POP3 Server implementation
...
package iMSCP::Servers::po::dovecot;
...
use Tie::File;
use Class::Autouse qw/ :nostat iMSCP::Servers::po::dovecot::installer iMSCP::Servers::po::dovecot::uninstaller /;
...
sub registerSetupListeners
{
    ...
    iMSCP::Servers::po::dovecot::installer->getInstance()->registerSetupListeners( $eventManager );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Servers::po::dovecot::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::po::dovecot::uninstaller->getInstance()->uninstall();
    $rs ||= $self->restart();
...
sub setEnginePermissions
{
    ...
    $rs ||= setRights(
        "$main::imscpConfig{'ENGINE_SBIN_DIR'}/quota/imscp-dovecot-quota.sh",
        {
...
=item _init()
 ...
 Return iMSCP::Servers::po::dovecot
