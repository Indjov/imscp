=head1 NAME
 ...
 iMSCP::Servers::po::dovecot::installer - i-MSCP Dovecot IMAP/POP3 Server installer implementation
...
package iMSCP::Servers::po::dovecot::installer;
...
=item _init()
 ...
 Return iMSCP::Servers::po::dovecot::installer
...
sub _init
{
    ...
    $self->{'po'} = iMSCP::Servers::po::dovecot->getInstance();
