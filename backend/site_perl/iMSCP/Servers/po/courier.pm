=head1 NAME
 ...
 iMSCP::Servers::po::courier - i-MSCP Courier IMAP/POP3 Server implementation
...
package iMSCP::Servers::po::courier;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Servers::po::courier::installer iMSCP::Servers::po::courier::uninstaller /;
use iMSCP::Config;
use iMSCP::Debug;
use iMSCP::Dir;
...
sub registerSetupListeners
{
    ...
    iMSCP::Servers::po::courier::installer->getInstance()->registerSetupListeners( $eventManager );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Servers::po::courier::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::po::courier::uninstaller->getInstance()->uninstall();
    $rs ||= $self->restart();
...
=item _init()
 ...
 Return iMSCP::Servers::po::courier
