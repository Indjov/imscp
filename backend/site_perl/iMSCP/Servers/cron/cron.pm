=head1 NAME
 ...
 iMSCP::Servers::cron::cron - i-MSCP Cron server implementation
...
package iMSCP::Servers::cron::cron;
    ...
    $cfgTpl = process(
        {
            ...
            BACKUPS_DIR     => $main::imscpConfig{'BACKUPS_DIR'}
        },
        $cfgTpl
    );
...
=item _init()
 ...
 Return iMSCP::Servers::cron::cron
