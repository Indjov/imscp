=head1 NAME
 ...
 iMSCP::Servers::ftpd::proftpd::uninstaller - i-MSCP Proftpd Server implementation
...
package iMSCP::Servers::ftpd::proftpd::uninstaller;

use strict;
use warnings;
use File::Basename;
use iMSCP::File;
use iMSCP::Servers::ftpd::proftpd;
...
=item _init()
 ...
 Return iMSCP::Servers::ftpd::proftpd::uninstaller
...
sub _init
{
    ...
    $self->{'ftpd'} = iMSCP::Servers::ftpd::proftpd->getInstance();
