=head1 NAME
 ...
 iMSCP::Servers::ftpd::proftpd::installer - i-MSCP Proftpd Server implementation
...
package iMSCP::Servers::ftpd::proftpd::installer;
...
=item _init()
 ...
 Return iMSCP::Servers::ftpd::proftpd::installer
