=head1 NAME
 ...
 iMSCP::Servers::ftpd::vsftpd::uninstaller - i-MSCP VsFTPd Server implementation
...
package iMSCP::Servers::ftpd::vsftpd::uninstaller;
...
=item _init()
 ...
 Return iMSCP::Servers::ftpd::vsftpd::uninstaller
...
sub _init
{
    ...
    $self->{'ftpd'} = iMSCP::Servers::ftpd::vsftpd->getInstance();
