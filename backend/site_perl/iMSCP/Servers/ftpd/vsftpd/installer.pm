=head1 NAME
 ...
 iMSCP::Servers::ftpd::vsftpd::installer - i-MSCP VsFTPd Server implementation
...
package iMSCP::Servers::ftpd::vsftpd::installer;
...
=item _init()
 ...
 Return iMSCP::Servers::ftpd::vsftpd::installer
