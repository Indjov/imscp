=head1 NAME
 ...
 iMSCP::Servers::ftpd::proftpd - i-MSCP ProFTPD Server implementation
...
package iMSCP::Servers::ftpd::proftpd;
...
use iMSCP::Rights;
use iMSCP::Service;
use Class::Autouse qw/ :nostat iMSCP::Servers::ftpd::proftpd::installer iMSCP::Servers::ftpd::proftpd::uninstaller /;
...
sub registerSetupListeners
{
    ...
    iMSCP::Servers::ftpd::proftpd::installer->getInstance()->registerSetupListeners( $eventManager );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Servers::ftpd::proftpd::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::ftpd::proftpd::uninstaller->getInstance()->uninstall();
...
=item _init()
 ...
 Return iMSCP::Servers::ftpd::proftpd
