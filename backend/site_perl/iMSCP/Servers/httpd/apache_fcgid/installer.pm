=head1 NAME
 ...
 iMSCP::Servers::httpd::apache_fcgid::installer - i-MSCP Apache2/FastCGI Server implementation
...
package iMSCP::Servers::httpd::apache_fcgid::installer;
...
use iMSCP::Servers::httpd::apache_fcgid;
...
=item _init()
 ...
 Return iMSCP::Servers::httpd::apache_fcgid::installer
...
sub _init
{
    ...
    $self->{'httpd'} = iMSCP::Servers::httpd::apache_fcgid->getInstance();
