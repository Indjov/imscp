=head1 NAME
 ...
 iMSCP::Servers::httpd::apache_fcgid - i-MSCP Apache2/FastCGI Server implementation
...
package iMSCP::Servers::httpd::apache_fcgid;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Servers::httpd::apache_fcgid::installer iMSCP::Servers::httpd::apache_fcgid::uninstaller /;
use File::Basename;
use File::Spec;
use File::Temp;
use iMSCP::Config;
...
{
    iMSCP::Servers::httpd::apache_fcgid::installer->getInstance()->registerSetupListeners( $_[1] );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Servers::httpd::apache_fcgid::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::httpd::apache_fcgid::uninstaller->getInstance()->uninstall();
...
=item _init()
 ...
 Return iMSCP::Servers::httpd::apache_fcgid
