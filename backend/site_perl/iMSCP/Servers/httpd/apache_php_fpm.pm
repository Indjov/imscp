=head1 NAME
 ...
 iMSCP::Servers::httpd::apache_php_fpm - i-MSCP Apache2/PHP-FPM Server implementation
...
package iMSCP::Servers::httpd::apache_php_fpm;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Servers::httpd::apache_php_fpm::installer iMSCP::Servers::httpd::apache_php_fpm::uninstaller /;
use File::Basename;
use File::Spec;
use File::Temp;
use iMSCP::Config;
...
{
    iMSCP::Servers::httpd::apache_php_fpm::installer->getInstance()->registerSetupListeners( $_[1] );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Servers::httpd::apache_php_fpm::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::httpd::apache_php_fpm::uninstaller->getInstance()->uninstall();
...
=item addIps(\%data)
 ...
 Param hash \%data IPs data as provided by the iMSCP::Modules::Ips module
 Return int 0 on success, other on failure
...
=item _init()
 ...
 Return iMSCP::Servers::httpd::apache_php_fpm
