=head1 NAME
 ...
 iMSCP::Servers::httpd::apache_itk - i-MSCP Apache2/ITK Server implementation
...
package iMSCP::Servers::httpd::apache_itk;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Servers::httpd::apache_itk::installer iMSCP::Servers::httpd::apache_itk::uninstaller /;
use File::Basename;
use File::Spec;
use File::Temp;
use iMSCP::Config;
...
{
    iMSCP::Servers::httpd::apache_itk::installer->getInstance()->registerSetupListeners( $_[1] );
}
...
sub install
{
    ...
    $rs ||= $rs = iMSCP::Servers::httpd::apache_itk::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Servers::httpd::apache_itk::uninstaller->getInstance()->uninstall();
...
=item _init()
 ...
 Return iMSCP::Servers::httpd::apache_itk
