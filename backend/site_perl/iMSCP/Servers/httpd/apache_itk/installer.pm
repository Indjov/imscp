=head1 NAME
 ...
 iMSCP::Servers::httpd::apache_itk::installer - i-MSCP Apache2/ITK Server implementation
...
package iMSCP::Servers::httpd::apache_itk::installer;
...
use iMSCP::Servers::httpd::apache_itk;
...
=item _init()
 ...
 Return iMSCP::Servers::httpd::apache_itk::installer
...
sub _init
{
    ...
    $self->{'httpd'} = iMSCP::Servers::httpd::apache_itk->getInstance();
