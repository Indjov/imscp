=head1 NAME
 ...
 iMSCP::Servers::httpd::apache_php_fpm::uninstaller - i-MSCP Apache2/PHP-FPM Server uninstaller
...
package iMSCP::Servers::httpd::apache_php_fpm::uninstaller;

use strict;
use warnings;
use iMSCP::Dir;
use iMSCP::File;
use iMSCP::Servers::httpd::apache_php_fpm;
...
=item _init()
 ...
 Return iMSCP::Servers::httpd::apache_php_fpm::uninstaller
...
sub _init
{
    ...
    $self->{'httpd'} = iMSCP::Servers::httpd::apache_php_fpm->getInstance();
