=head1 NAME
 ...
 iMSCP::Installer::Adapter::Ubuntu - Ubuntu installer adapter
...
package iMSCP::Installer::Adapter::Ubuntu;

use strict;
use warnings;
use parent 'iMSCP::Installer::Adapter::Debian';

=head1 DESCRIPTION

 i-MSCP installer adapter implementation for Ubuntu.
...
=item _init()
 ...
 Return iMSCP::Installer::Adapter::Ubuntu
